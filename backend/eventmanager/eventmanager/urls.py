...
from eventmanager.auth import (
    ...
    LogoutView, ProfileView, IsAuthenticatedView , check_auth , UserProfileByIdView
)
...
urlpatterns = [
    ...
    path('api/auth/user-profile/', UserProfileByIdView.as_view() , name='user_profile_by_id'),
    # Include app URLs
